package com.FSC.UI.InterActiveObject.DisplayObjectContainer.SWFLoader
{
	...
	public class SWFLoader extends EventDispatcher
	{
		...
		private function InitLoadEvent(p_info : LoaderInfo) : void
		{
			...
			p_info.addEventListener(ProgressEvent.PROGRESS, this.ProgressHandler);
			p_info.addEventListener(Event.COMPLETE, this.CompleteHandler);
			p_info.addEventListener(IOErrorEvent.IO_ERROR, this.ErrorHandler);
			p_info.addEventListener(SecurityErrorEvent.SECURITY_ERROR, this.ErrorHandler);
		}
		/**
		 * @private
		 * 移除加载事件
