...
package com.flashloaded.as3{
	...
	// Protected Properties:
		...
		private var _compX:Number;
		private var _compY:Number;
	...
	//	Protected
		...
		private function initPosition(x:Number,y:Number):void{
			_compX=x;
			_compY=y;
			this.x=x;
			this.y=y;
		...
		public function get compX():Number{
			return _compX;
		}
		public function get compY():Number{
			return _compY;
		}
	}
}